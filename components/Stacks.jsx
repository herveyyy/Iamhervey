    ...
    <div className="w-full  flex flex-col justify-center items-center p-2 ">
      ...
      >
        <div className=" gap-1 flex items-center justify-center h-16 w-16 lg:w-20 lg:h-20 duration-1000">
          ...
          <p className="font-light text-sm ">React</p>
        </div>
        <div className=" flex items-center justify-center gap-1 h-16 w-28 lg:w-28 lg:h-20  duration-1000">
          <div>
            <svg
        ...
        <div className=" flex items-center justify-center h-16 w-16 lg:w-20 lg:h-20 duration-1000">
          <div className="w-10 h-10 ">
            <img alt="vite" src="https://vitejs.dev/logo-with-shadow.png" />
          </div>
        ...
        <div className=" flex items-center justify-center h-16 w-16 lg:w-20 lg:h-20  duration-1000">
          <img
            alt="firebase"
            src="https://www.gstatic.com/devrel-devsite/prod/vc5df62aff689c916c31b2ac1e49a7e8c5ecada1bb13dcdd68aaefb1e1e9b9ec0/firebase/images/lockup-dark-theme.svg"
          />
        </div>
        <div className=" flex items-center justify-center h-16 w-16 lg:w-20 lg:h-20  duration-1000">
