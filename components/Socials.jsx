  ...
  return (
    <div className="  border flex justify-center border-gray-900 shadow-white/5 rounded-lg bg-white/5 backdrop-blur-sm ">
      <div className=" flex justify-evenly  p-2 w-96 h-14">
        <a
          href="https://www.facebook.com/herveyMp"
          target="_blank"
        ...
        <a
          href="https://www.github.com/herveyyy"
          target="_blank"
        ...
        <a
          href="https://www.linkedin.com/in/hervey-geralph-mapano-a7821b262/"
          target="_blank"
        ...
        <a
          href="mailto:mapano.herveygeralph@gmail.com"
