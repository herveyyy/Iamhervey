...
const ProjectCard = ({
    ...
    return (
        <div
            ...
            className=" sm:w-80 h-80 w-72   flex flex-col  cursor-pointer group   "
        >
            <div className=" h-72 object-cover overflow-hidden rounded-t-3xl -z-10 translate-y-0 group-hover:translate-y-36 duration-700 ">
                <Image
                    src={coverImage}
            ...
            <div
                className={`h-full translate-y-0 ${
                    checkTitleLength
                        ? " group-hover:-translate-y-20"
                        : " group-hover:-translate-y-10"
                } duration-700`}
            >
                <p className="font-mono text-center items-center  text-sm ">
                    {title || "Project Title"}
                </p>

                <div className=" flex justify-center w-full px-6">
                    <div className="border-b group-hover:border-b-gray-600 border-b-gray-900  w-full duration-700"></div>
                </div>
            </div>
